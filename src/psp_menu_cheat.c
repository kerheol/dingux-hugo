...
psp_cheat_menu_load(int format)
{
  ...
  if (ret ==  1) /* load OK */
  {
    ...
    psp_sdl_back2_print(140, 180, "File loaded !",
                       PSP_MENU_NOTE_COLOR);
    psp_sdl_flip();
    sleep(1);
  }
  ...
  {
    psp_display_screen_cheat_menu();
    psp_sdl_back2_print(140, 180, "Can't load file !",
...
psp_cheat_menu_save()
{
  ...
  {
    psp_display_screen_cheat_menu();
    psp_sdl_back2_print(140, 180, "File saved !",
                       PSP_MENU_NOTE_COLOR);
    psp_sdl_flip();
    sleep(1);
  }
  ...
  {
    psp_display_screen_cheat_menu();
    psp_sdl_back2_print(140, 180, "Can't save file !",
                       PSP_MENU_WARNING_COLOR);
    psp_sdl_flip();
    sleep(1);
  }
...
psp_cheat_menu_del_cheat()
{
  ...
  if (a_cheat->type == HUGO_CHEAT_NONE) {
    ...
    psp_display_screen_cheat_menu();
    psp_sdl_back2_print(140, 180, "Cheat is empty !",
                       PSP_MENU_NOTE_COLOR);
    psp_sdl_flip();
    sleep(1);
...
psp_cheat_menu_add_cheat()
{
  ...
  if (! scan_addr_found) {
    psp_display_screen_cheat_menu();
    psp_sdl_back2_print(140, 180, "No address to add !",
                       PSP_MENU_NOTE_COLOR);
    psp_sdl_flip();
    sleep(1);
...
{
  psp_display_screen_cheat_menu();
  psp_sdl_back2_print(140, 180, "Reset cheat !", PSP_MENU_NOTE_COLOR);
  psp_sdl_flip();
  sleep(1);
...
psp_cheat_menu_enable_all_cheat()
{
  ...
  if (cur_type == HUGO_CHEAT_NONE) {
    ...
    psp_display_screen_cheat_menu();
    psp_sdl_back2_print(140, 180, "Cheats are empty !",
                       PSP_MENU_NOTE_COLOR);
    psp_sdl_flip();
    sleep(1);
...
psp_cheat_menu_save_ram()
{
  ...
  psp_display_screen_cheat_menu();
  psp_sdl_back2_print(140, 180, "Ram saved !",
                      PSP_MENU_NOTE_COLOR);
  psp_sdl_flip();
  sleep(1);
}
