...
# define MENU_KBD_KBD_SELECT  MENU_KBD_SKIN+1
# define MENU_KBD_UP          MENU_KBD_KBD_SELECT+1
# define MENU_KBD_DOWN        MENU_KBD_UP+1
# define MENU_KBD_LEFT        MENU_KBD_DOWN+1
# define MENU_KBD_RIGHT       MENU_KBD_LEFT+1
# define MENU_KBD_CROSS       MENU_KBD_RIGHT+1
# define MENU_KBD_SQUARE      MENU_KBD_CROSS+1
# define MENU_KBD_TRIANGLE    MENU_KBD_SQUARE+1
# define MENU_KBD_CIRCLE      MENU_KBD_TRIANGLE+1
# define MENU_KBD_LTRIGGER    MENU_KBD_CIRCLE+1
# define MENU_KBD_RTRIGGER    MENU_KBD_LTRIGGER+1
#if !defined(GCW0_MODE)
# define MENU_KBD_FIRE        MENU_KBD_RTRIGGER+1
# define MENU_KBD_JOY_UP      MENU_KBD_FIRE+1
#else
# define MENU_KBD_JOY_UP      MENU_KBD_RTRIGGER+1
#endif
# define MENU_KBD_JOY_DOWN    MENU_KBD_JOY_UP+1
# define MENU_KBD_JOY_LEFT    MENU_KBD_JOY_DOWN+1
# define MENU_KBD_JOY_RIGHT   MENU_KBD_JOY_LEFT+1

# define MENU_KBD_LOAD        MENU_KBD_JOY_RIGHT+1
# define MENU_KBD_SAVE        MENU_KBD_LOAD+1
# define MENU_KBD_HOTKEYS     MENU_KBD_SAVE+1
# define MENU_KBD_RESET       MENU_KBD_HOTKEYS+1

# define MENU_KBD_BACK        MENU_KBD_RESET+1
